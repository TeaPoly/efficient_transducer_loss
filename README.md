# Transducer-OptimizedLoss

Efficient encoder and prediction output combination and calculate the transducer loss utterance by utterance.
...
- Section 3.1. Efficient encoder and prediction output combination. IMPROVING RNN TRANSDUCER MODELING FOR END-TO-END SPEECH RECOGNITION (https://arxiv.org/pdf/1909.12415.pdf) 
